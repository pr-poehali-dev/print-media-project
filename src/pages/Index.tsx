...
const Index = () => {
  ...
  const priceList = [
    { service: 'Широкоформатная печать (м²)', price: 'от 500 ₽' },
    { service: 'Баннер 3×6 м', price: 'от 3 500 ₽' },
    { service: 'Табличка А4', price: 'от 800 ₽' },
    { service: 'Картина на холсте 50×70 см', price: 'от 2 500 ₽' },
    { service: 'Сольвентная печать (м²)', price: 'от 600 ₽' },
    { service: 'УФ печать на пластике (м²)', price: 'от 1 200 ₽' },
  ];
